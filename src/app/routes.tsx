      ...
      children: [
        {
          ...
          children: [
            ...
            { path: ROUTES.crm.missionControl, element: <Navigate to={ROUTES.dashboard} replace /> },
            ...
            { path: ROUTES.crm.contacts, element: <ModulePlaceholder title="Contact Directory" module="CRM" /> },
            { path: ROUTES.crm.opportunities, element: <ModulePlaceholder title="Opportunity Pipeline" module="CRM" /> },
            { path: ROUTES.crm.activities, element: <ModulePlaceholder title="Activities & Follow-Ups" module="CRM" /> },
            { path: ROUTES.crm.campaigns, element: <ModulePlaceholder title="Campaign Manager" module="CRM" /> },
